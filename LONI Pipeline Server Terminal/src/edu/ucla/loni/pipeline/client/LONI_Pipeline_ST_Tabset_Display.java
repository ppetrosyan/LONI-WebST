...
public class LONI_Pipeline_ST_Tabset_Display {
	...
	private Tab setPreferencesTab_Access() {
		...
		dynamicForm.setFields(serverAdmin);getClass();
		formatForm(dynamicForm);
		...
		com.smartgwt.client.widgets.Label label_1 = new com.smartgwt.client.widgets.Label("<b><font size=2>Directory Access Control</font></b>");
		...
		final SelectItem selectItem = new SelectItem("newSelectItem_1", "Access control mode");
		...
		selectItem.addChangedHandler(new ChangedHandler() {
			public void onChanged(ChangedEvent event) {
	          ...
	          //case0
			  if ((selectItem.getValueAsString()).equals("0 -Executables: no restrictions. Remote File Browser: no restrictions."))
		    	  {
		    	    textItem_1.setTitle("Controlled users");
		    	    textItem_2.setTitle("Controlled directories");
		    	    textItem_1.setDisabled(true);
			  ...
			  //case1
			  else if ((selectItem.getValueAsString()).equals("1 - Executables: restricted below. Remote File Browser: no restrictions"))
		    	  {
				  textItem_1.setDisabled(true);
				     textItem_2.setDisabled(true);
		    	    textItem_1.setTitle("Restricted users");
		    	    textItem_2.setTitle("Restricted users only have access in these directories");
		    	    textItem_1.setDisabled(false);
			        textItem_2.setDisabled(false);
		    	  }
		      //case2
			  else if ((selectItem.getValueAsString()).equals("2 - Executables: enabled. Remote File Browser: no restrictions"))
		      {
				  textItem_1.setDisabled(true);
				     textItem_2.setDisabled(true);
		    	  	textItem_1.setTitle("Special users with no restrictions");
		    	    textItem_2.setTitle("Regular users only have access in these directories");
		    	    textItem_1.setDisabled(false);
			        textItem_2.setDisabled(false);
		    	  }
		      //case3
			  else if ((selectItem.getValueAsString()).equals("3 - Executables: restricted below. Remote File Browser: restricted below"))
		      { 
				  textItem_1.setDisabled(true);
				     textItem_2.setDisabled(true);
		    	    textItem_1.setTitle("Restricted users");
		      ...
		      //case4
			  else if ((selectItem.getValueAsString()).equals("4 - Executables: enabled below. Remote File Browser: enabled below"))
              {   
				  textItem_1.setDisabled(true);
				     textItem_2.setDisabled(true);
            	     textItem_1.setTitle("Special users with no restrictions");
			  ...
			  //case5
			  else if ((selectItem.getValueAsString()).equals("5 - Executables: restricted below. Remote File Browser: same as Shell permissions"))
			  {	
				 textItem_1.setDisabled(true);
			     textItem_2.setDisabled(true);
			     textItem_1.setTitle("Restricted users");
		      ...
		      //case6
			  else if ((selectItem.getValueAsString()).equals("6 - Executables: enabled below. Remote File Browser: same as Shell permissions"))
              {  
				  textItem_1.setDisabled(true);
			    textItem_2.setDisabled(true);
            	textItem_1.setTitle("Special users with no restrictions");
		      ...
		      //case7
			  else if ((selectItem.getValueAsString()).equals("7 - Executables: same as Shell permissions. Remote File Browser: same as Shell"))
		      {  
		    	    textItem_1.setTitle("Controlled users");
		        textItem_2.setTitle("Controlled directories");
		        textItem_1.setDisabled(true);
		...
		dynamicForm2.setFields(new FormItem[] { selectItem, textItem_1, textItem_2});
		String[] sitesArray = {"0 -Executables: no restrictions. Remote File Browser: no restrictions", 
		...
		dynamicForm3.setFields(canvasItem_1, 
				   			  	spinnerItem_1, 
				   			  	canvasItem_2, 
				   			  	spinnerItem_2);
