...
/**
 * Uploader Image Button with multiple file selection, drag and drop support, and GWT Progress Bars
 * example of GWT SWF Uploader.
 */
public class LONI_Pipeline_Server_Terminal implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        RootPanel.get("uploadContainer").add(horizontalPanel);
    }
